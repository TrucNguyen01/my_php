...
<body>
    ...
    $sql_code = "select * from donhang where TrangThai = 2 limit $socode1Trang offset $offset";
...
<div class="header">
        ...
        <div class="body">
            ...
            <div class="body_right">
                ...
                <div class="title">
                    <h2>Danh sách đơn hàng giao thành công</h2>
                </div>
                    ...
                    <table border="1">
                        ...
                        <?php $stt = 0; foreach($kq as $value) { $stt++; ?>
                            <tr>
                                ...
                                <th>
                                     <?php echo "<i>Giao hàng thành công</i>" ?>
                                </th>
                                <th>
            ...
            <button style="height: 20px; width: 30px; margin-top: 10px; margin-right: 10px;">
                <a style="text-decoration: none;color: black;" href="order_true.php?trang=<?php echo $i ?>">
                    <?php echo $i ?>
                </a>
            </button>
            <?php }
