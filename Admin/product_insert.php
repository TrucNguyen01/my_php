        ...
        <div class="body">
            ...
            <div class="body_right">
                ...
                <div class="body_right_insert">
                    <form action="product_insert_mysql.php" method="post" onsubmit="return check_insert()">
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input id="ten" type="text" name="tensanpham"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea style="border-radius: 10px; padding-top: 2px; border: none; outline: none;" name="mota" id="motas" cols="47" rows="6"></textarea>
                            </td>
                            <td class="title">Số lượng </td>
                            <td><input id="soluongs" name="soluong" type="number"></td>
                        </tr>
                        <tr>
                            <td class="title" rowspan="3">Mô tả chi tiết </td>
                            <td rowspan="3">
                                <textarea  style="border-radius: 12px; padding-top: 3px; border: none; outline: none;" name="motachitiet" id="motachitiets" cols="47" rows="14"></textarea>
                            </td>
                            <td class="title" rowspan="1">Giá </td>
                            <td><input id="tien" name="gia" type="text"></td>
                        </tr>
                        <tr>
                            <td class="title">Giá giảm </td>
                            <td><input id="giagiams" name="giagiam" type="text"></td>
                        </tr>
                        <tr>
                            <td class="title">Độ hot </td>
                            <td><input id="dohots" name="dohot" type="text"></td>
                        </tr>
                        
                        <tr><td></td><td></td><td></td><td><button style="border-radius: 6px; outline: none; border: none;margin-left: 200px;" ><input style="width: 120px; height: 30px; border: none; outline: none;border-radius: 6px; cursor: pointer;" type="submit" value="Thêm"></button></td></tr>
                    </table>
                    </form>
                </div>
            </div>
