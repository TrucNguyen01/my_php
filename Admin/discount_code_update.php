...
<head>
    ...
    <style>
        *{
        ...
        .frame_news_insert .body .body_right_insert table th{
            height: 30px;
        }
        ...
        <div class="body">
            ...
            <div class="body_right">
                ...
                <div class="body_right_insert">
                    <form action="discount_code_update_mysql.php" method="post" onsubmit="return check()">
                    <table>
                        <tr></tr>
                        <tr><td></td><th></th><td><input hidden style="width: 60px; border-radius: 10px; border: none; outline: none; font-size: 18px; margin-left: 10px;" value="<?php echo $_GET['id'] ?>" type="text" name="id"></td></tr>
                        <tr><td>Mã giảm giá</td></tr>
                        <tr><td><input id="code" value="<?php echo $kq['code'] ?>" style="border: none;outline: none; border-radius: 10px;" type="text" name="magiamgia"></td></tr>
                        <tr><td>Số lần nhập</td></tr>
                        <tr><td><input id="sl"  value="<?php echo $kq['SoLanNhap'] ?>"  style="border: none;outline: none; border-radius: 10px;"  type="text" name="solannhap"></td></tr>
                        <tr><td>Số tiền giảm</td></tr>
                        <tr><td><input id="tiengiam"  value="<?php echo $kq['SoTienGiam'] ?>"  style="border: none;outline: none; border-radius: 10px;"  type="text" name="sotiengiam"></td></tr>
                        <tr><td>Đơn hàng tối thiểu</td></tr>
                        <tr><td><input id="toithieu"  value="<?php echo $kq['DonHangToiThieu'] ?>"  style="border: none;outline: none; border-radius: 10px;"  type="text" name="donhangtoithieu"></td></tr>
                        <tr><td>Ngày hết hạn</td></tr>
                        <tr><td><input id="hethan"  value="<?php echo $kq['NgayHetHan'] ?>"  style="border: none;outline: none; border-radius: 10px;"  type="date"  name="ngayhethan"></td></tr>
