...
<head>
    ...
    <style>
        ...
        .frame_best_selling_product .featured_product{
            display: flex;
            flex-wrap: wrap;
            width: 100%;
        }
        .frame_best_selling_product .featured_product .frame_product{
            width: 238px;
        }
        .frame_best_selling_product img{
            width: 120px;
            height: 150px;
            margin-left: 16px;
            transition: 0.3s;
        }
        .frame_best_selling_product img:hover{
            scale: 1.06;
        }
        .frame_best_selling_product .featured_product .product_discount{
            position: absolute;
        ...
        .frame_best_selling_product .featured_product .frame_product .product_name{
            width: 200px;
        }
        .frame_product{
            display: flex;
        ...
        .header_best_selling_product table{
            width: 100%;            
        }
        .header_best_selling_product table caption{
            text-align: left;
            margin-left: 30px;
            margin-top: 10px;
        }
...
<body>
    ...
    ?>
    <div class="frame_best_selling_product">
        <div class="body">
        <div class="header_best_selling_product">
            <table>
                <caption><h1>SẢN PHẨM BÁN CHẠY</h1></caption>
            </table>
        </div>
